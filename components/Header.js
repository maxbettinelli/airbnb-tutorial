    ...
    <header className=' sticky top-0 z-50 grid grid-cols-3 bg-white shadow-md p-5 md:px-10'>
        ...
        <div className='flex items-center md:border-2 rounded-full py-2 md:shadow-sm'>
            <input value={searchInput} 
                    ...
                    className=' flex-grow pl-5 bg-transparent outline-none text-gray-700 placeholder-gray-500' type="text" placeholder={placeholder || "start your search"}></input>
        ...
        { searchInput && (
        <div className='flex flex-col col-span-3 mx-auto bg-white text-black'>
            <DateRangePicker 
            ...
            <div className='flex items-center border-b mb-4'>
                ...
                <input value={numberOfGuests}
                        type="number" 
                        min={1}
                        className="w-12 pl-2 text-lg outline-none text-red-400 bg-white border" 
